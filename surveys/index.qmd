...
In addition to these advantages, respondent companies demonstrate leadership by supporting an evidence-based policy framework for their sector. 

To express interest in participating in an Industry Survey, please contact vincent.brain\@bridge2food.com.
...
|--------                                                         | ------- | ------ |
| [Plant Protein Supplier (PPS) Survey](pps.qmd)                  | Quarterly | January 2, 2025 |
| [Plant Meat Producer (PMP) Survey](pmp.qmd)                     | Quarterly | January 2, 2025 |
| [Plant Dairy Producer (PDP) Survey](pdp.qmd)                    | Quarterly | January 2, 2025 |
| [Mycoprotein Producer (MPP) Survey](mpp.qmd)                    | Quarterly | January 2, 2025 |
| [Cell-Cultured Food Producer (CCFP) Survey](ccfp.qmd)           | Quarterly | January 2, 2025 |
| [Microbial & Recombinant Food Producer (MRFP) Survey](mrfp.qmd) | Quarterly | January 2, 2025 |
| [Protein Technology Investor (PTI) Survey](pti.qmd)             | Quarterly | January 2, 2025 |
| [Industry Analyst (IA) Survey](ia.qmd)                          | Quarterly | January 2, 2025 |
